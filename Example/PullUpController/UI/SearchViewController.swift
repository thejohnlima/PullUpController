...
class SearchViewController: PullUpController {
    ...
    var initialPointOffset: CGFloat {
        ...
        switch initialState {
        case .contracted:
            result = searchBoxContainerView?.frame.height ?? 0
            result += margin
        case .expanded:
            result = pullUpControllerPreferredSize.height
        }
    ...
    override func viewDidLoad() {
        ...
        portraitSize = CGSize(width: width, height: secondPreviewView.frame.maxY)
